...
Main = (function()
	...
	Main.InitEnv = function()
		...
		local s, r = pcall(function()
			...
			writefile("testfolder/test.txt", "Ok")
			return readfile("testfolder/text.txt")
		end)
		local supportsfilesys = r == "Ok"
		-- file
		env.readfile = supportsfilesys and readfile
		env.writefile = supportsfilesys and writefile
		env.makefolder = supportsfilesys and makefolder
